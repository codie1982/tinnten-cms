...
export const MENU_SIDEBAR = [
  ...
  { heading: 'OPERATIONS' },
  {
    ...
    path: '/cms/orders',
    children: [
      { id: 'order-list', title: 'Tüm Siparişler', path: '/cms/orders/list' },
      {
        id: 'order-returns',
        title: 'İade / İptaller',
        path: '/cms/orders/returns',
      },
      {
        id: 'order-shipments',
        title: 'Kargo & Teslimatlar',
        path: '/cms/orders/shipments',
      },
    ],
  },
  {
    id: 'requests-offers',
    title: 'Talep / Teklif Yönetimi',
    icon: MessageSquare,
    path: '/cms/requests',
    children: [
      {
        id: 'requests-inbox',
        title: 'Talep Kutusu',
        path: '/cms/requests/inbox',
      },
      {
        id: 'offers-pipeline',
        title: 'Teklif Pipeline',
        path: '/cms/requests/offers',
      },
      {
        id: 'requests-analytics',
        title: 'Analiz & Raporlar',
        path: '/cms/requests/analytics',
      },
    ],
  },
  { heading: 'PARTNERS' },
  ...
  },
  {
    ...
    icon: Shield,
    path: '/cms/company-approvals',
    children: [
      {
        id: 'seller-applications',
        title: 'Satıcı Başvuruları',
        path: '/cms/company-approvals/applications',
      },
      {
        id: 'kyc-review',
        title: 'KYC / Evrak Kontrolü',
        path: '/cms/company-approvals/kyc',
      },
    ],
  },
  {
  ...
  { heading: 'FINANCE' },
  {
    ...
    children: [
      {
        id: 'escrow-balances',
        title: 'Bakiye & Blokeler',
        path: '/cms/escrow/balances',
      },
      {
        id: 'escrow-releases',
        title: 'Ödeme Serbest Bırakma',
        path: '/cms/escrow/releases',
      },
      {
        id: 'escrow-disputes',
        title: 'İhtilaflar',
        path: '/cms/escrow/disputes',
      },
    ],
  },
  {
    ...
    children: [
      {
        id: 'platform-purchases',
        title: 'Platform Satın Almaları',
        path: '/cms/purchases/platform',
      },
      {
        id: 'marketing-spend',
        title: 'Reklam / Pazarlama Harcamaları',
        path: '/cms/purchases/marketing',
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        title: 'Paketler',
        path: '/cms/subscriptions/plans',
      },
      {
        id: 'company-subscriptions',
        title: 'Firma Üyelikleri',
        path: '/cms/subscriptions/companies',
      },
      {
        id: 'usage-limits',
        title: 'Kullanım & Limitler',
        path: '/cms/subscriptions/usage',
      },
    ],
  },
    ...
    children: [
      {
        ...
        path: '/cms/settings/payments',
      },
      {
        id: 'shipping-integrations',
        title: 'Kargo Entegrasyonları',
        path: '/cms/settings/shipping',
      },
      { id: 'logs', title: 'Log & Denetim', path: '/cms/settings/logs' },
    ],
  },
];
