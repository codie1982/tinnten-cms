...
export default function ChannelMembersPage() {
  ...
  return (
    <RoleGuard allowedRoles={[CMS_ROLES.EDITOR]}>
      <PageHeader
        section="Email · Kanallar"
        title={`Üyeler: ${key}`}
        description="Onaylı kullanıcıları bu kanala ekleyin/çıkarın (kampanya alıcı listesi)"
        actions={
          <Link href="/cms/email/channels">
            <Button variant="outline">
              <ArrowLeft className="size-4" /> Kanallar
            </Button>
          </Link>
        }
      />
